<!-- 提现方式 -->
<template>
	<ui-modal class="ss-checkout-counter-wrap" name="walletTransfterBalance" mask="40" align="bottom" ui="ss-r-t-30"
		:showCancel="false" :option="false">
...
<script setup>
	...
	const showModal = () => {
		hooksModal.showModal('walletTransfterBalance')
	}
	const hideModal = () => {

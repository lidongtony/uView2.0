<template>
	<ui-modal class="add-bank-wrap" name="walletAddAlipay" mask="40" align="bottom" ui="ss-r-t-30" :showCancel="false"
		:option="false">
		<view class="ss-modal-box bg-white ss-flex-col">
			...
			<view class="modal-content ss-flex-1 ss-p-b-100">
				<ui-form ref="addAlipayFormRef" :model="state.model" :rules="state.rules" hasClear labelPosition="left"
